...
| R-002 | Required authority sign-offs remain outstanding | P0-TASK-009 reviewed repository/searchable acceptance surfaces and found no new authority acceptance records; affected controlled behavior remains non-deployable until role-specific decisions are recorded | OPEN |
...
| R-008 | Privileged-role password-length option remains undecided | Current controlled default remains 8; P0-TASK-009 found no adoption decision for 12 characters | OPEN |
